...
const filterBodyPartsBtn = document.querySelector('button[data-name="Body parts"]');
const filterEquipmentBtn = document.querySelector('button[data-name="Equipment"]');
...
async function createGalleryMarkup(filter) {
    try {
        ...
        exercisesList.insertAdjacentHTML('beforeend', createGalleryCards(categoriesExercises.results));
    } catch (error) {
